...
class ExportPenggunaTahunan implements FromCollection, WithHeadings, WithMapping, WithDrawings,WithStyles,WithEvents
{
    /**
    ...
    */
    ...
    public function collection()
    {
        return Pengguna::select("penggunas.nim","penggunas.nama","penggunas.nomor_telp","ruangans.nama_ruang", "tas.label","penggunas.created_at","penggunas.tgl_kembali")
                    ...
                    ->whereYear('penggunas.created_at', $this->year)
                    ->get();
    }
